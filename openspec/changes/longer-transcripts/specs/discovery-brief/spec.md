...
The system SHALL reject input longer than 90,000 characters before calling the LLM and tell
...
- **WHEN** the user submits 100,000 characters
- **THEN** no LLM call is made and the user sees a message with the 90,000 character limit and their current length
